...
public class ProductController {
  ...
  public ResponseEntity<Product> getProductByID(@RequestBody ProductRequest productRequest) {
    return new ResponseEntity<>(productService.getProductByID(productRequest.getIdProduct()),
        HttpStatus.OK);
  }

  @PostMapping("/get-product-by-name")
  public ResponseEntity<ProductDTO> getAllProductByName(
  ...
  public ResponseEntity<ProductDTO> getListProductByPrice(
      @RequestBody ProductRequest productRequest) {
  ...
  public ResponseEntity<List<ProductAndProductTypeDTO>> getInformationProduct(
      @RequestParam(required = false) String
          nameProduct, @RequestParam(required = false) String nameProductType) {
    List<ProductAndProductTypeDTO> typeDTOList = productService.getListProductByNameProduct(
        nameProduct, nameProductType);
    return new ResponseEntity<>(typeDTOList, HttpStatus.OK);
  }

  @GetMapping("/get-product-by-name-and-price")
  public List<Product> getListProductByNameProductAndNameProductType(
  ...
  public ResponseEntity<ProductDescriptionDTO> createProductAndDescription(
      @RequestBody ProductAndDesciptionRequest productAndDesciptionRequest) {
    ProductDescriptionDTO descriptionDTO = productService.createProductAndDescription(
        productAndDesciptionRequest);
