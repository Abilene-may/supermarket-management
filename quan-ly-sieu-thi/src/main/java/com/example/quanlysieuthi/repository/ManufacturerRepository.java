...
public interface ManufacturerRepository extends JpaRepository<Manufacturer, Long> {
  ...
  @Query(value =
      "SELECT hsx.id_manufacturer , hsx.name_manufacturer , hsx.origin , hsx.founded_year\n" +
          "FROM manufacturer hsx LEFT JOIN  product_type_manufacturers lsphsx "
          + "on hsx.id_manufacturer  = lsphsx.manufacturers_id_manufacturer\n"
          + " LEFT JOIN product_type lsp on lsp.id_product_type = lsphsx.product_type_id_product_type\n"
          + "WHERE lsp.name_product_type = :nameProductType",
      nativeQuery = true)
...
//    @Transactional
  @Query(value = "UPDATE manufacturer \n" +
      ...
      nativeQuery = true)
  void updateMaufacturer(Long idManufacturer, String nameManufacturer, String origin,
      int foundedYear);
